...
public class EventActions
{
    ...
    [Action("List events", Description = "Retrieve a list of events in a calendar. If calendar is not " +
    ...
    [Action("Get event", Description = "Get information about an event.")]
    ...
    [Action("List occurrences of event", Description = "Get the occurrences of an event for a specified time range.")]
    ...
    [Action("List recently created events", Description = "Retrieve a list of events created during past hours. " +
    ...
    [Action("List recently updated events", Description = "Retrieve a list of events updated during past hours. " +
    ...
    [Action("Create event in a calendar", Description = "Create a new event in a calendar. If calendar is not " +
    ...
    [Action("Cancel event", Description = "This action allows the organizer of a meeting to send a cancellation " +
    ...
    [Action("Cancel event occurrence", Description = "This action allows the organizer of a meeting to send " +
    ...
    [Action("Forward event", Description = "This action allows the organizer or attendee of a meeting event " +
    ...
    [Action("Update event", Description = "Update an existing event. Specify fields that need to be updated.")]
    ...
    [Action("Update event occurrence", Description = "Update an existing occurrence of a recurring event. " +
    ...
    [Action("Delete event", Description = "Delete an event.")]
